...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      babel: {
        files: ['<%= yeoman.client %>/{app,components,services,filters}/**/!(*.spec|*.mock).js'],
      ...
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,components,services,filters}/**/!(*.spec|*.mock).js',
          '!<%= yeoman.client %>/app/app.js'
        ],
        tasks: ['injector:scripts']
      },
      injectCss: {
        files: ['<%= yeoman.client %>/{app,components,services,filters}/**/*.css'],
        tasks: ['injector:css']
      },
      mochaTest: {
      ...
      injectLess: {
        files: ['<%= yeoman.client %>/{app,components,services,filters}/**/*.less'],
        tasks: ['injector:less']
      },
      less: {
        files: ['<%= yeoman.client %>/{app,components,services,filters}/**/*.less'],
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{app,components,services,filters}/**/*.{css,html}',
          '{.tmp,<%= yeoman.client %>}/{app,components,services,filters}/**/!(*.spec|*.mock).js',
    ...
    jshint: {
      ...
      all: ['<%= yeoman.client %>/{app,components,services,filters}/**/!(*.spec|*.mock).js'],
      test: {
        src: ['<%= yeoman.client %>/{app,components,services,filters}/**/*.{spec,mock}.js']
      }
    },
    ...
    ngtemplates: {
      ...
      main: {
        cwd: '<%= yeoman.client %>',
        src: ['{app,components,services,filters}/**/*.html'],
    ...
    copy: {
      ...
      styles: {
        ...
        cwd: '<%= yeoman.client %>',
        dest: '.tmp/',
        src: ['{app,components,services,filters}/**/*.css']
      }
    },
    ...
    babel: {
      ...
      client: {
        files: [{
          expand: true,
          cwd: '<%= yeoman.client %>',
          src: ['{app,components,services,filters}/**/!(*.spec).js'],
          dest: '.tmp'
        }]
      },
      server: {
    ...
    injector: {
      ...
      less: {
        ...
        files: {
          '<%= yeoman.client %>/app/app.less': [
            '<%= yeoman.client %>/{app,components,services,filters}/**/*.less',
            '!<%= yeoman.client %>/app/app.less'
          ]
        }
      },
      ...
      css: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            '<%= yeoman.client %>/{app,components,services,filters}/**/*.css'
          ]
        }
      }
    },
